...
private:
    ...
    rclcpp::Service<art_gripper_interfaces::srv::TargetWidth>::SharedPtr _target_width_server;
    rclcpp::Service<art_gripper_interfaces::srv::TargetPose>::SharedPtr _target_pose_server;
